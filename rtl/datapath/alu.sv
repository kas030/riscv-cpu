...
//     [8] beq  [9] bne [10] blt [11] bge [12] bgeu [13] bltu [22] cpop
//   设计要点：
...
module alu #(
    ...
    logic m_sra , m_beq , m_bne , m_blt , m_bge , m_bgeu, m_bltu, m_cpop, m_crc8;
    logic [DATAWIDTH-1:0] add_lhs, add_rhs;
    logic                 cin, cout;
    logic [DATAWIDTH-1:0] r_addsub, r_and, r_or, r_xor;
    logic [DATAWIDTH-1:0] r_sll, r_srl, r_sra, r_cpop, r_crc8;
    ...
    always_comb begin
        r_cpop = '0;
        for (cpop_i = 0; cpop_i < DATAWIDTH; cpop_i = cpop_i + 1)
            r_cpop = r_cpop + A[cpop_i];
    end
