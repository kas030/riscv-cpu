...
module alu #(
    ...
    always_comb begin
        r_zip = '0;
        for (zip_i = 0; zip_i < 16; zip_i = zip_i + 1) begin
            r_zip[2*zip_i] = A[zip_i];
            r_zip[2*zip_i+1] = A[zip_i+16];
        end
    end
