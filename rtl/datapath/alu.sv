...
//     [8] beq  [9] bne [10] blt [11] bge [12] bgeu [13] bltu [22] xperm4
//   设计要点：
...
module alu #(
    ...
    always_comb begin
        r_xperm4 = '0;
        xperm4_index = '0;
        for (xperm4_i = 0; xperm4_i < 8; xperm4_i = xperm4_i + 1) begin
            xperm4_index = B[4*xperm4_i +: 4];
            if (xperm4_index < 8)
                r_xperm4[4*xperm4_i +: 4] = A[4*xperm4_index +: 4];
        end
    end
