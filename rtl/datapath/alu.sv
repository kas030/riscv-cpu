...
module alu #(
    ...
    always_comb begin
        r_unzip = '0;
        for (unzip_i = 0; unzip_i < 16; unzip_i = unzip_i + 1) begin
            r_unzip[unzip_i] = A[2*unzip_i];
            r_unzip[unzip_i+16] = A[2*unzip_i+1];
        end
    end
