...
module alu #(
    ...
    assign r_orc_b = {((|A[31:24]) ? 8'hff : 8'h00), ((|A[23:16]) ? 8'hff : 8'h00), ((|A[15:8]) ? 8'hff : 8'h00), ((|A[7:0]) ? 8'hff : 8'h00)};
