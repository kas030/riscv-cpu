...
//   每一位对应 alu 的一种运算（RV32I 算术逻辑/比较 + RV32M 乘除余 + Zbb orc.b）。
...
module alu_ctrl(
    ...
    input  logic [4:0]                    funct5    ,      // R 型 rs2 / I 型 shamt
    ...
    localparam logic [`ALU_OP_WIDTH - 1:0] OP_ORCB   = 23'h400000;
