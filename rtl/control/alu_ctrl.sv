...
//   位于 ID 级，根据 opcode + funct7/funct5/funct3 译码出独热 ALUControl，
...
module alu_ctrl(
    ...
    input  logic [4:0]                    funct5    ,      // I 型固定低 5 位
    ...
    localparam logic [`ALU_OP_WIDTH - 1:0] OP_CPOP   = 23'h400000;
    ...
    assign do_cpop = kind_i && funct7 == 7'b0110000 &&
                     funct5 == 5'b00010 && funct3 == 3'b001;
