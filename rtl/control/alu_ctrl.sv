...
module alu_ctrl(
    ...
    localparam logic [`ALU_OP_WIDTH - 1:0] OP_CLMUL  = 23'h400000;
    ...
    assign ALUControl = {`ALU_OP_WIDTH{do_add   }} & OP_ADD    |
                        ...
                        {`ALU_OP_WIDTH{do_clmul }} & OP_CLMUL  |
    ...
    assign do_clmul = kind_r && funct7 == 7'b0000101 && funct3 == 3'b001;
