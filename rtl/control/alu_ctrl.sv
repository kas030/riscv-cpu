...
module alu_ctrl(
    ...
    localparam logic [`ALU_OP_WIDTH - 1:0] OP_CLZ    = 23'h400000;
    ...
    assign do_clz  = kind_i && funct7 == 7'b0110000 &&
                     funct5 == 5'b00000 && funct3 == 3'b001;
