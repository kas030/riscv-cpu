...
module alu_ctrl(
    ...
    localparam logic [`ALU_OP_WIDTH - 1:0] OP_ZEXT_H = 23'h400000;
    ...
    assign ALUControl = {`ALU_OP_WIDTH{do_add   }} & OP_ADD    |
                        ...
                        {`ALU_OP_WIDTH{do_zext_h}} & OP_ZEXT_H;
    ...
    assign do_zext_h = kind_r && funct7 == 7'h04 && instr[24:20] == 5'h00 && funct3 == 3'h4;
endmodule
