...
\begin{tikzpicture}[x=1cm,y=1cm]
  ...
  \node[block, minimum width=120pt, minimum height=40pt] (irom0) at (5.11,5.8) {
    {\bfseries Instruction ROM 0}\\Address: pc[15:2]
  };
  \node[block, minimum width=120pt, minimum height=40pt] (irom1) at (5.11,4.05) {
  ...
  \draw[databoth] (irom0.west -| core.east) -- node[bus label, above=2pt, fill=none, text=ink] {
    irom\_addr[31:0] \\ irom\_data[31:0]
  } (irom0.west);
  \draw[databoth] (irom1.west -| core.east) -- node[bus label, above=2pt, fill=none, text=ink] {
