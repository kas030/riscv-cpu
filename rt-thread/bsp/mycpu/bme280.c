...
/* 0x80200070--0x80200080 由 CoreMark MMIO FPU 使用；I2C 独立放在其后。 */
#define I2C_DEV_ADDR_REG  (*(volatile rt_uint32_t *)0x80200084ul)
#define I2C_REG_ADDR_REG  (*(volatile rt_uint32_t *)0x80200088ul)
#define I2C_DATA_REG      (*(volatile rt_uint32_t *)0x8020008cul)
#define I2C_CTRL_REG      (*(volatile rt_uint32_t *)0x80200090ul)
